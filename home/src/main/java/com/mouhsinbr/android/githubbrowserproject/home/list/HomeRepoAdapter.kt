...
import com.mouhsinbr.android.githubbrowserproject.home.databinding.RepoItemBinding
...
class HomeRepoAdapter: RecyclerView.Adapter<HomeRepoAdapter.RepoItemViewHolder>() {
    ...
    fun setRepoItem(repoItems: List<RepoItem>) {
        data.clear()
    ...
    class RepoItemViewHolder(private val binding: RepoItemBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(repoItem: RepoItem) {
            ...
            binding.forkCount.text = "${repoItem.forksCount}"
        }
